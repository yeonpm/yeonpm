...
- 실거래 데이터 기반 차량 시세 산출·등급 결정 자동화(Python, RANSAC): 적용 이후 경매 낙찰률 10% 초반 → 20% 내외, 최초 적용 표본 기준 시세 커버리지 약 60% → 85%
- 시세 예측 검증: 2023-12 개발 단계 분석 표본 82,269건에서 오차 중앙값 7%·평균 11.9% (|예측가 − 실제 거래가| ÷ 예측가 기준, 운영 지표 아님)
