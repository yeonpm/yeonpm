...
- 신규 시세 조회 기능 적용 이후 내차팔기 경매 서비스 낙찰률이 기존 대비 약 60~70% 상승
- 실제 판매 차량의 거래 데이터를 활용해, 담당자의 추정에 의존하던 시세 등급 결정을 객관적인 데이터 기반으로 전환
- 차량 시세 산출에 필요한 데이터 처리를 자동화하고, 사람이 수행하던 시세 등급 결정 프로세스 제거
- U2-Net 기반 차량 이미지 배경 제거와 번호판 마스킹·그림자 합성 등 이미지 전처리 구현
- 차량 이미지 합성: NVIDIA DGX Spark에서 YOLO26 Pose를 파인튜닝하고, 차량 사진의 키포인트 좌표를 추론하는 비전 모델 운용 (2026 3Q)
...
<img src="https://img.shields.io/badge/MCP-000000?style=for-the-badge&logo=MCP&logoColor=white" alt="MCP" />
<img src="https://img.shields.io/badge/Chrome_Extension-E6E6E6?style=for-the-badge&logo=googlechrome&logoColor=white" alt="Chrome Extension" />
</div>
